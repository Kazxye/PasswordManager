...
from app.models.vault import Vault      # noqa: F401
...
# Metadata for autogenerate — Alembic compares this against the DB
...
def do_run_migrations(connection) -> None:
    """Configures and runs migrations with a live connection."""
    context.configure(
